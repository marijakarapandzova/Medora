...
public interface MedicalRecordRepository extends JpaRepository<MedicalRecord, Long> {
    ...
    // recordId is NOT auto-generated by the database (supplied by the application),
    // so callers must compute the next free ID before saving a new MedicalRecord.
    @Query("SELECT COALESCE(MAX(e.recordId), 0) FROM MedicalRecord e")
