...
public interface BillingRepository extends JpaRepository<Billing, Long> {
    ...
    // billId is NOT auto-generated by the database (supplied by the application),
    // so callers must compute the next free ID before saving a new Billing.
    @Query("SELECT COALESCE(MAX(e.billId), 0) FROM Billing e")
    Long findMaxBillId();
