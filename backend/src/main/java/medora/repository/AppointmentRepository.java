...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    // appointmentId is NOT auto-generated by the database (supplied by the application),
    // so callers must compute the next free ID before saving a new Appointment.
    @Query("SELECT COALESCE(MAX(e.appointmentId), 0) FROM Appointment e")
